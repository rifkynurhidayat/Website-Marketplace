    ...
    <div class="page-content page-home">
        ...
        <section class="store-trend-categories">
            <div class="container">
                ...
                <div class="row">
                    @php $incremenetCategory = 0 @endphp
                    @forelse ($categories as $category)
                    <div class="col-6 col-md-3 col-lg-2" data-aos="fade-up" data-aos-delay="{{  $incremenetCategory += 100 }}">
                    ...
                    <div class="col-md-12 text-center py-5">
                        <h6 class="text-muted">Products not found</h6>
                    </div>
                    @endforelse
                </div>
            </div>
