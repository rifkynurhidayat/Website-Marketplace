                                      ...
                                      @csrf
                                        <div class="row">
                                            <div class="col-12 mt-2">
                                                <h5>Shpping information</h5>
                                            </div>
                                            <div class="col-12">
                                                <div class="row">
                                                    <div class="col-12 col-md-6">
                                                        <div class="product-title">Address I</div>
                                                        <div class="product-subtitle">{{ $transaction->transaction->user->addres_one }}</div>
                                                    </div>
                                                    <div class="col-12 col-md-6">
                                                        <div class="product-title">Address II</div>
                                                        <div class="product-subtitle">{{ $transaction->transaction->user->addres_two }}</div>
                                                    </div>
                                                    <div class="col-12 col-md-6">
    ...
    <script>
        var transactionDetails = new Vue({
            ...
            data: {
                ...
                resi: "{{ $transaction->transaction->resi }}",
            },
        });
    </script>
@endpush
